...
export const InputRange: React.FC<Props> = ({ formSearch, setFormSearch }) => {
  ...
  return (
    <div className='input-number-container relative'>
      <input
        ...
        onBlur={handleBlur}
        className='bg-dark text-light font-bold border-primary outline-none p-2 rounded border w-full'
      />
